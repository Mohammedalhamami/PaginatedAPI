...
namespace HPlusSport.API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetAllProducts([FromQuery] ProductQueryParameters queryParameters)
        {
            ...
            {
                products = products.Where(p => p.Price >= queryParameters.MinPrice.Value).OrderBy(p => p.Price);
            }

            if(queryParameters.MaxPrice != null)
            {
                products = products.Where(p => p.Price <= queryParameters.MaxPrice.Value).OrderBy(p => p.Price);
            }
